      ...
      if call.from_user.id in info.lobby.game[id]['players']: 
        if info.lobby.game[id]['players'][call.from_user.id]['currentmessage']==info.lobby.game[id]['players'][call.from_user.id]['lastmessage']:
          if info.lobby.game[id]['players'][call.from_user.id]['ready']!=1:
            ...
            back=emojize(':back:', use_aliases=True) 
            Keyboard=types.InlineKeyboardMarkup()
            Keyboard.add(types.InlineKeyboardButton(text=emoj0+info.lobby.game[id]['players'][call.from_user.id]['name1mob']+"\n"+manacost+str(nc0.cost), callback_data=info.lobby.game[id]['players'][call.from_user.id]['mobsinturn'][0]),types.InlineKeyboardButton(text='Цена: '+manacost+str(nc0.cost), callback_data='no'),types.InlineKeyboardButton(text='Инфо', callback_data=mobtoinfo(info.lobby.game[id]['players'][call.from_user.id]['mobsinturn'][0])))
            Keyboard.add(types.InlineKeyboardButton(text=emoj1+info.lobby.game[id]['players'][call.from_user.id]['name2mob']+"\n"+manacost+str(nc1.cost), callback_data=info.lobby.game[id]['players'][call.from_user.id]['mobsinturn'][1]),types.InlineKeyboardButton(text='Цена: '+manacost+str(nc1.cost), callback_data='no'),types.InlineKeyboardButton(text='Инфо', callback_data=mobtoinfo(info.lobby.game[id]['players'][call.from_user.id]['mobsinturn'][1])))
            Keyboard.add(types.InlineKeyboardButton(text=emoj2+info.lobby.game[id]['players'][call.from_user.id]['name3mob']+"\n"+manacost+str(nc2.cost), callback_data=info.lobby.game[id]['players'][call.from_user.id]['mobsinturn'][2]),types.InlineKeyboardButton(text='Цена: '+manacost+str(nc2.cost), callback_data='no'),types.InlineKeyboardButton(text='Инфо', callback_data=mobtoinfo(info.lobby.game[id]['players'][call.from_user.id]['mobsinturn'][2])))
            Keyboard.add(types.InlineKeyboardButton(text=back+"Главное меню", callback_data='menu'))
